...
5. All Operations
    ...
    1.  Create a function named lots_of_math(). This function should have four parameters named a, b, c, and d. The function should print 3 lines and return 1 value.

    2.  First, print the sum of a and b.

    3.  Second, print c minus d.

    4.  Third, print the first number printed, multiplied by the second number printed.

    5.  Finally, return the third number printed modulo a.
